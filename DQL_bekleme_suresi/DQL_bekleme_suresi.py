...
MODEL_FILE = os.path.join(OUTPUT_DIR, "dql_bekleme_suresi_model.pth")
STATS_FILE = os.path.join(OUTPUT_DIR, "dql_bekleme_suresi_stats.csv")
CSV_FIELDS = [
    "episode",
    "run_episode",
    "total_steps",
...
# Simulasyondaki aktif araclarin toplam bekleme suresini hesaplar.
